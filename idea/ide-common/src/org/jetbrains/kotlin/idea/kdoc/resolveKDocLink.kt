...
private class ExtensionsScope(
    ...
    private val receiverTypes = listOf(KotlinTypeFactory.simpleNotNullType(Annotations.EMPTY, receiverClass, emptyList())) //TODO?
    ...
    override fun getContributedDescriptors(kindFilter: DescriptorKindFilter, nameFilter: (Name) -> Boolean): Collection<DeclarationDescriptor> {
        ...
        return contextScope.collectDescriptorsFiltered(kindFilter exclude DescriptorKindExclude.NonExtensions, nameFilter)
